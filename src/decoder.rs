...
create_instruction_decoder!(
    ...
    (Call, CsIp, [0b10011010], [0b11111111]),
    ...
    (
        JmpFar,
        RM,
        [0b11111111, 0b00101000],
        [0b11111111, 0b00111000]
    ),
    (Jmp, CsIp, [0b11101010], [0b11111111]),
    (Ret, NoOps, [0b11000011], [0b11111111]),
    (RetFar, NoOps, [0b11001011], [0b11111111]),
    (Ret, Data16, [0b11000010], [0b11111111]),
    (RetFar, Data16, [0b11001010], [0b11111111]),
